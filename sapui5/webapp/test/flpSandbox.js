					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoices List2",
									"targetURL": "#sapui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapui5-display": {
								"semanticObject": "sapui5",
								"action": "display",
								"description": "Invoices List2",
								"title": "Invoices List2",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sapui5",
									"url": sap.ui.require.toUrl("sapui5")
								}
							}
						}
					}
